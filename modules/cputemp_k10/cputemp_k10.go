...
// CPU temperature for AMD processors via k10temp
package cputemp_k10 // import "barista.run/modules/cputemp_k10"
...
func New() *Module {
  files, _ := afero.ReadDir(fs, "/sys/module/k10temp/drivers/pci:k10temp")
  m := &Module{
    thermalFile: fmt.Sprintf("/sys/module/k10temp/drivers/pci:k10temp/%s/hwmon/hwmon1/temp1_input", files[0].Name()),
